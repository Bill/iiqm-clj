...
;; @@
;; =>
;;; {"type":"vega","content":{"width":400,"height":247.2187957763672,"padding":{"top":10,"left":50,"bottom":20,"right":10},"scales":[{"name":"x","type":"linear","range":"width","zero":false,"domain":{"data":"00e91fbf-23bb-4595-820b-abb09a1ce1d5","field":"data.x"}},{"name":"y","type":"linear","range":"height","nice":true,"zero":false,"domain":{"data":"00e91fbf-23bb-4595-820b-abb09a1ce1d5","field":"data.y"}}],"axes":[{"type":"x","scale":"x"},{"type":"y","scale":"y"}],"data":[{"name":"00e91fbf-23bb-4595-820b-abb09a1ce1d5","values":[{"x":10,"y":4},{"x":100,"y":21},{"x":1000,"y":693},{"x":7000,"y":10578},{"x":20000,"y":83195}]},{"name":"dcfcd11b-dc51-449f-8b25-9b8a8e19f778","values":[{"x":10,"y":2},{"x":100,"y":8},{"x":1000,"y":296},{"x":7000,"y":17182},{"x":20000,"y":141237}]},{"name":"97344f76-c62b-49f9-a1c1-37bafca71db6","values":[{"x":10,"y":3},{"x":100,"y":12},{"x":1000,"y":170},{"x":7000,"y":7819},{"x":20000,"y":64358}]},{"name":"6a99fd9a-c854-44f1-b221-3ed1b361b931","values":[{"x":10,"y":30},{"x":100,"y":61},{"x":1000,"y":223},{"x":7000,"y":2021},{"x":20000,"y":7032}]}],"marks":[{"type":"line","from":{"data":"00e91fbf-23bb-4595-820b-abb09a1ce1d5"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"blue"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}},{"type":"line","from":{"data":"dcfcd11b-dc51-449f-8b25-9b8a8e19f778"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"red"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}},{"type":"line","from":{"data":"97344f76-c62b-49f9-a1c1-37bafca71db6"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"cyan"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}},{"type":"line","from":{"data":"6a99fd9a-c854-44f1-b221-3ed1b361b931"},"properties":{"enter":{"x":{"scale":"x","field":"data.x"},"y":{"scale":"y","field":"data.y"},"stroke":{"value":"green"},"strokeWidth":{"value":2},"strokeOpacity":{"value":1}}}}]},"value":"#gorilla_repl.vega.VegaView{:content {:width 400, :height 247.2188, :padding {:top 10, :left 50, :bottom 20, :right 10}, :scales [{:name \"x\", :type \"linear\", :range \"width\", :zero false, :domain {:data \"00e91fbf-23bb-4595-820b-abb09a1ce1d5\", :field \"data.x\"}} {:name \"y\", :type \"linear\", :range \"height\", :nice true, :zero false, :domain {:data \"00e91fbf-23bb-4595-820b-abb09a1ce1d5\", :field \"data.y\"}}], :axes [{:type \"x\", :scale \"x\"} {:type \"y\", :scale \"y\"}], :data ({:name \"00e91fbf-23bb-4595-820b-abb09a1ce1d5\", :values ({:x 10, :y 4} {:x 100, :y 21} {:x 1000, :y 693} {:x 7000, :y 10578} {:x 20000, :y 83195})} {:name \"dcfcd11b-dc51-449f-8b25-9b8a8e19f778\", :values ({:x 10, :y 2} {:x 100, :y 8} {:x 1000, :y 296} {:x 7000, :y 17182} {:x 20000, :y 141237})} {:name \"97344f76-c62b-49f9-a1c1-37bafca71db6\", :values ({:x 10, :y 3} {:x 100, :y 12} {:x 1000, :y 170} {:x 7000, :y 7819} {:x 20000, :y 64358})} {:name \"6a99fd9a-c854-44f1-b221-3ed1b361b931\", :values ({:x 10, :y 30} {:x 100, :y 61} {:x 1000, :y 223} {:x 7000, :y 2021} {:x 20000, :y 7032})}), :marks ({:type \"line\", :from {:data \"00e91fbf-23bb-4595-820b-abb09a1ce1d5\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"blue\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}} {:type \"line\", :from {:data \"dcfcd11b-dc51-449f-8b25-9b8a8e19f778\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"red\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}} {:type \"line\", :from {:data \"97344f76-c62b-49f9-a1c1-37bafca71db6\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"cyan\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}} {:type \"line\", :from {:data \"6a99fd9a-c854-44f1-b221-3ed1b361b931\"}, :properties {:enter {:x {:scale \"x\", :field \"data.x\"}, :y {:scale \"y\", :field \"data.y\"}, :stroke {:value \"green\"}, :strokeWidth {:value 2}, :strokeOpacity {:value 1}}}})}}"}
;; <=
